<header>
    ...
    <div id="top-header" style="background-color: black !important">
        <div class="container">
            <ul class="header-links pull-left">
                <li><a href="#"><i class="fa fa-phone" style="color:#d12e00f0 !important"></i> +023-45-67-89</a></li>
                <li><a href="#"><i class="fa fa-envelope-o" style="color:#d12e00f0 !important"></i> victory@email.com</a>
                </li>
                <li><a href="#"><i class="fa fa-map-marker" style="color:#d12e00f0 !important"></i> TP Hồ Chí Minh
                        </a></li>
            </ul>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="header-logo">
                        <a href="#" class="logo">
                            <img style="border-radius:100%" src="{{ asset('logo/logoheader.jpg') }}" alt="" style="width:100%">
                        </a>
                    </div>
                </div>
                <!-- /LOGO -->
